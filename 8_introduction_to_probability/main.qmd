...
- **Sample Space** - Totality of all possible outcoesn of an experiment.

- **Equally Likely** - All outcomes of an experiment having the same chance of occurence.

## Terms and Definitions - Events
...
- **Event** - Set of outcomes of an experiment defined by a given rule.
  ...
  - **Mutually Exclusive Events** - Two events A and B are mutuall exclusive if they cannot occur together. 
  
  - **Independent Events** - Two events are independent if the occurence of one does not affects the occurence of the other event. 
  
## Terms and Definitions - Probability Values
...
## Terms and Definitions - Complement of an event 
...
- ## Terms and Definitions - Notations
