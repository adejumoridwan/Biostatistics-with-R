...
- Discrete events are observed in a continuous interval o time, space and volume.
...
- If on average 4 patients experience a heart attach in a hospital per day, the Poisson distribution can model the probability of having exactly 6 heart attacks in a given day.
