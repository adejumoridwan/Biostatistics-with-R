...
- **Hypothesis testing**: Compare the parameters for two samples using statistical tests of significance, for example investigating whether a particular racial group have higher blood sugar level on average when compared to another racial group.
