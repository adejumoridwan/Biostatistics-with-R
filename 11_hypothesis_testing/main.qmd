...
Statement about an expected relationship between one or more independentt variables and a dependent variable

## Types of Hypothesis

- **Research Hypothesis:** Statement that motivates the research

- **Statistical Hypothesis:** Statements that can be evaluateed by statistical techniques.
...
- Probabiliy of committing a type I error is denoted by $\alpha$

- Incorreclty concluding that a difference exists, when actually there is no difference

- A fase positive decision

## Type II Error

- Accepting a false null hypothesis

- Probabiliy of committing a type II error is denoted by $\beta$
...
- Measure of the amount of evidence we have againstt the null hypothesis


- The smaller the p-value the more the evidence againstt $H_0$ and vice versa

## P-value Interpretation

- If $\alpha=0.05$, and $\text{p-value}<0.03$, this implies statistical signficance.
