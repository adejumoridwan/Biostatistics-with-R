...
2. ✓ Calculate realistic effect sizes
3. ✓ Perform sensitivity analyses
4. ✓ Consider resource constraints
5. ✓ Document all assumptions

## Power Analysis: Best Practices (contd.)

**During Study:**

- Monitor recruitment and retention
- Track actual effect sizes
- Reassess if needed (cautiously!)


## Common Pitfalls to Avoid

**❌ Conducting power analysis after data collection**

- This is "post-hoc" power analysis
- Circular reasoning
- Not valid for interpretation

## Common Pitfalls to Avoid (contd.)

**❌ Assuming effect sizes without justification**
...
- Budget, time, recruitment feasibility


## Reporting Sample Size Justification

**In Research Proposals/Papers:**

"Sample size was determined using power analysis. To detect a medium effect size (Cohen's d = 0.5) with 80% power at α = 0.05 using a two-sided independent samples t-test, 64 participants per group are required (total N = 128). This calculation is based on effect sizes reported in Smith et al. (2023). To account for potential attrition, we will recruit 80 participants per group (N = 160)."
...
- R Documentation: `?pwr` package
- G*Power software (free alternative)

## Resources for Further Learning (contd.)

**Online Calculators:**

- StatPages.info
- ClinCalc.com
- Sample size calculators by test type

**Always verify calculations using multiple methods!**

## Next Steps in Your Research

**Checklist:**

□ Identify your primary outcome and test type

□ Determine expected effect size from literature
...
1. Is this effect size clinically/practically meaningful?
2. Can we realistically recruit this many participants?
3. What if the true effect is smaller than expected?
4. Have we considered all sources of variability?
5. Do we need to adjust for multiple testing?
6. Is our power adequate for secondary outcomes?


## Appendix: Effect Size Cheat Sheet
...
## Appendix: Effect Size Cheat Sheet (contd.)
